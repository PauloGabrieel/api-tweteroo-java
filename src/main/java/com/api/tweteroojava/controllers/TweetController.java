...
public class TweetController {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<List<TweetsModel>> getAlltweetsByUsername(@PathVariable String username) {
        return ResponseEntity.status(HttpStatus.OK).body(tweetService.getAllByUsername(username));
